...
loginForm.addEventListener('submit', (e) => {
    ...
    loginButtonText.innerHTML = `Login &nbsp; <img style="-webkit-transform: translateY(.6rem); transform: translateY(.6rem);" src="/la/data/auth/login-loading-tp.gif" alt="..." width="30px" height="30px"/>`
...
forgotPassword.addEventListener('click',(e) => {    
    ...
    forgotButtonText.innerHTML = `Forgot Password &nbsp; <img style="-webkit-transform: translateY(.6rem); transform: translateY(.6rem);" src="/la/data/auth/forgot-password-loading-tp.gif" alt="..." width="30px" height="30px"/>`
