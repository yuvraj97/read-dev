...
if(currTheme == "light"){
	theme.href ="/la/data/assets/css/main-light.css"
	auththeme.href = "/la/data/auth/authStyle-light.css"
}
else if(currTheme == "dark") {
	theme.href = "/la/data/assets/css/main-dark.css"
	auththeme.href = "/la/data/auth/authStyle-dark.css"
}
