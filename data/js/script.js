if("chapterID" in quantml) requireScript('chapter-js', '0.1.4', '/data/js/chapter.js', function(){});
...
function extraWork(){
	applyAnalytics()
	requireScript('dwin-js', '0.1.4', 'https://www.dwin2.com/pub.838437.min.js', function(){})
}
...
function cssLoaded(isKatexImportant = true, callback){
	...
	setTimeout(function(){
		requireScript('swiped-events-js', '0.1.4', '/data/js/swiped-events.js', function(){})				
		if(typeof(importPrism) != "undefined" && importPrism == true) requireScript('prism-js', '0.1.4', '/data/prism/prism.js', function(){})
	}, 500)
