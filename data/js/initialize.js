...
function changeThemeCSS(currentTheme){
	...
	if(currentTheme == "dark"){
		...
		requireScript("main-dark-css", "0.1.3", "/data/css/main-dark.css", function(){})
		// requireScript("auth-dark-css", "0.1.3", "/data/css/authStyle-dark.css", function(){})
		...
		requireScript("main-light-css", "0.1.3", "/data/css/main-light.css", function(){})
		// requireScript("auth-light-css", "0.1.3", "/data/css/authStyle-light.css", function(){})
...
if(typeof(importPrism) != "undefined" && importPrism == true) requireScript('prism-css', '0.1.3', '/data/prism/prism.css', function(){});
